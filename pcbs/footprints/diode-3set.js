    ...
    function diode(from, to, x) {
      ...
      return `
        ...
        (module SmdDiode (layer B.Cu)
          ...
          ${''/* diode symbol */}
          (fp_line (start ${x+1} -1.65) (end ${x+1} +2.45) (layer B.SilkS) (width 0.1))
          (fp_line (start ${x+1} +2.45) (end ${x-1} +2.45) (layer B.SilkS) (width 0.1))
          (fp_line (start ${x-1} +2.45) (end ${x-1} -1.65) (layer B.SilkS) (width 0.1))
          ...
          (fp_line (start ${x-1} -2.45) (end ${x+1} -2.45) (layer B.CrtYd) (width 0.05))
          (fp_line (start ${x+1} -2.45) (end ${x+1} +2.45) (layer B.CrtYd) (width 0.05))
          (fp_line (start ${x+1} +2.45) (end ${x-1} +2.45) (layer B.CrtYd) (width 0.05))
          (fp_line (start ${x-1} +2.45) (end ${x-1} -2.45) (layer B.CrtYd) (width 0.05))
        )
